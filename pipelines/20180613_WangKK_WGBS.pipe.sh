...
while read sname; do
  ...
  ### QC fastq ####
  input_fastq1=fastq/${sname}_combined_R1.fastq.gz
  input_fastq2=fastq/${sname}_combined_R2.fastq.gz
  ...
  ## alignment
  pipeline_depend none
  fastq1=fastq/${sname}_combined_R1.fastq.gz
  fastq2=fastq/${sname}_combined_R2.fastq.gz
  ...
  hour=12; memG=80; ppn=20; queue=longq
  pipeline_depend 14
