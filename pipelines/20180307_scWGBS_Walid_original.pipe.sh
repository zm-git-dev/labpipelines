...
while read sname; do
  ...
  ### QC fastq ####
  input_fastq1=fastq/${sname}_L005_R1_001.fastq.gz
  input_fastq2=fastq/${sname}_L005_R2_001.fastq.gz
  ...
  fastq=fastq/${sname}_L005_R2_001.fastq.gz
  ...
  ## alignment
  pipeline_depend none
  fastq1=fastq/${sname}_L005_R1_001.fastq.gz
  fastq2=fastq/${sname}_L005_R2_001.fastq.gz
